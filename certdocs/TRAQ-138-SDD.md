...
##### REQ-TRAQ-SWL-020 Certification document names
...
##### REQ-TRAQ-SWL-014 Accessing and linking to requirements
...
```
<a name="#REQ-TRAQ-SWL-001">REQ-TRAQ-SWL-001</a>
```

- each requirement referred to in the document is replaced with a link to that requirement. For example a reference to the High Level Requirement REQ-TRAQ-SYS-001 will be replaced with:

```
<a href="https://a/REQ-TRAQ-SYS-001">REQ-TRAQ-SYS-001</a>
```
...
Note that the URL redirector needs to infer the name of the document the requirement is defined in, as described in REQ-TRAQ-SWL-002.

###### Attributes:
- Rationale: this ensures that all documents defining or reference requirements don’t introduce typing mistakes.
- Parents: REQ-TRAQ-SWH-012
- Verification: Unit test
- Safety impact: None


##### REQ-TRAQ-SWL-002 Construct the requirement URL.

The <abbr title="Requirements Management Tool">RMT</abbr> SHALL infer the document where a requirement is defined solely based on the name of the requirement. The correct name as defined by REQ-TRAQ-SWL-020 can be uniquely constructed as follows:
- take the second part of the requirement id, representing the project/system abbrev, e.g. "TRAQ" for "REQ-TRAQ-SYS-001"
...
##### REQ-TRAQ-SWL-003 Uniform requirement ID format.
...
- Verification: Unit test.
- Safety impact: None.
- Parent: REQ-TRAQ-SWH-002


##### REQ-TRAQ-SWL-004 Valid requirement references.

The RMT SHALL check that the requirements referred to in each document exist (and thus have a correct id):

- for each requirement reference, check if the referenced requirement exists in the requirement map constructed as described in REQ-TRAQ-SWL-015
...
##### REQ-TRAQ-SWL-005 ID allocation.
...
- Verification: Unit test.
- Safety impact: None.
- Parent: REQ-TRAQ-SWH-003


##### REQ-TRAQ-SWL-017 Deleted requirements.

Deleted requirements are requirements that do not apply anymore (e.g. they are obsolete). Deleted requirements SHALL be marked by changing the title to "Deleted", for example "REQ-TRAQ-SWL-015 Deleted"
...
- Verification: Unit test
- Safety impact: None
- Parents: REQ-TRAQ-SWH-004, REQ-TRAQ-SWH-005


##### REQ-TRAQ-SWL-006 Tracing system to high, low level, implementation, test
...
- Parents: REQ-TRAQ-SWH-004, REQ-TRAQ-SWH-007
- Verification: Test.
- Safety impact: None.


##### REQ-TRAQ-SWL-007. Tracing implementation, test to low, high, system level.
...
**Note:** This is identical to REQ-TRAQ-SWL-006, except that the report is generated in reverse order.

###### Attributes:
- Rationale: the report will be used by the certification authority to visualize requirement tracing.
- Parents: REQ-TRAQ-SWH-005
- Verification: Test.
- Safety impact: None.


##### REQ-TRAQ-SWL-008. Change impact tracing
...
The report generation described in REQ-TRAQ-SWL-006 will be able to receive the following inputs:
...
```
reqtraq report 
reqtraq report REQ-TRAQ-SWL-008,REQ-TRAQ-SWL-009,REQ-TRAQ-SWL-010
...
- Parents: REQ-TRAQ-SWH-006
- Verification: Test.
- Safety impact: None.


##### REQ-TRAQ-SWL-018 Phabricator export

The RMT SHALL export all requirements as Phabricator tasks, in the following format:

- Title: requirement title, e.g. "REQ-TRAQ-SWL-018 Phabricator export"
- Assigned To: empty
- Status: Open
- Priority: Normal
...
##### REQ-TRAQ-SWL-009. Change history tracing
...
The report described in REQ-TRAQ-SWL-006 addresses this requirement. Each LLR will contain both the source files that implement it and the CLs that implemented it.

###### Attributes:
- Parents: REQ-TRAQ-SWH-007
- Verification: Test.
- Safety impact: None.


##### REQ-TRAQ-SWL-010. Change justification tracing
...
- Parents: REQ-TRAQ-SWH-008
- Verification: Test.
- Safety impact: None.


##### REQ-TRAQ-SWL-011. Report readability
...
###### Attributes:
- Rationale: reports on the bidirectional traceability have to be submitted as evidence in certification trajectories. The report generated in REQ-TRAQ-SWL-006 addresses this issue.
- Parents: REQ-TRAQ-SWH-009
- Verification: Demonstration.
- Safety impact: None


##### REQ-TRAQ-SWL-012. Filtering of output
...
- Parents: REQ-TRAQ-SWH-010
- Verification: Demonstration
- Safety impact: None


##### REQ-TRAQ-SWL-016 Web interface
...
- Parents: REQ-TRAQ-SWH-011
- Verification: Demonstration
- Safety impact: None


##### REQ-TRAQ-SWL-019 Pandoc markdown rendering
