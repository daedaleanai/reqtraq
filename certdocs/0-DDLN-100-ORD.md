...
#### REQ-RQTQ-SYS-7 Requirement Document Types
...
- Software/Hardware Requirements Document, which contain <abbr title="high-level requirements">HLR</abbr>
- Software/Hardware Design Document, which contain <abbr title="low-level requirements">LLR</abbr>.
...
#### REQ-RQTQ-SYS-8 Requirement Document Hierarchy
...
#### REQ-RQTQ-SYS-1 Bidirectional tracing
...
#### REQ-RQTQ-SYS-2. Change impact tracing.
...
#### REQ-RQTQ-SYS-3. Change history tracing.
...
#### REQ-RQTQ-SYS-4. Change justification tracing.
...
#### REQ-RQTQ-SYS-6. Requirement Attributes.
